...
public class CtrComentarioMaster implements ActionListener {
    private Comentario mod;
    private DbComentarioMaster modDb;
    private FrmMenuMaster frm;
    private boolean verificarBusqueda = false;

    public CtrComentarioMaster(Comentario mod, DbComentarioMaster modDB, FrmMenuMaster frm) {
        this.mod = mod;
        this.modDb = modDB;
        this.frm = frm;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == frm.btnGuardarComentario) {
            ...
            DbUsuarioMaster usuarioDb = new DbUsuarioMaster();
            DbPeliculaMaster peliculaDb = new DbPeliculaMaster();
